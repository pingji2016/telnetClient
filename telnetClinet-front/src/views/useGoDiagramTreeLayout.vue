...
<div style="height: auto;">
    <diagram ref='diag' :model-data='diagramData' @model-changed='modelChanged' @changed-selection='changedSelection' style='border: solid 1px black; width:100%; height:600px'></diagram>
...
<!--    &lt;!&ndash;<textarea style='width:100%;height:250px'>{{ savedModelText }}</textarea>&ndash;&gt;-->
